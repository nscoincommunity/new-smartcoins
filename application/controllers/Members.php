...
class Members extends CI_Controller {
	...
	function index() {
		...
		$this->load->view('sw-member/home',$data);
		$this->load->view('sw-member/footer',$data);
	}
	
	function cloud_mining_machine() {
		cek_session_members();
		$this->load->view('sw-member/header',$data);
		$this->load->view('sw-member/cloud_mining_machine',$data);
		$this->load->view('sw-member/footer',$data);
	}
	...
	function profile(){
		...
		$this->load->view('sw-member/header',$data);
		$this->load->view('sw-member/profile',$data);
		$this->load->view('sw-member/footer',$data);
