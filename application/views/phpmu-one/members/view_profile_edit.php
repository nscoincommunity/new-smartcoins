           ...
           Pastikan data-data dibawah ini sudah benar, agar tidak terjadi kesalahan saat transaksi.</p>";
                  ...
                  echo "<table class='table table-hover table-condensed'>
                        <thead>
                          ...
                          <tr class='danger'><td colspan='2'><p style='padding:6px'><i><b>Catatan :</b>  Khusus Untuk mengubah Informasi Rekening silahkan kontak Admin <a href='".base_url()."page/detail/hubungi-kami'>Disini</a>.</i></p></td></tr>
