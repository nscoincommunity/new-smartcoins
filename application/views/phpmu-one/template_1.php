...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="https://cryptotrend.id/asset/images/logo.png" />
    ...
    <footer style='background:#f4f4f4; border-top:1px solid #e3e3e3'>
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>
                      <small class='text-footer'>Copyright (c) 2019 - <?php echo $iden['nama_website']; ?> <br>
  ...
  <!--  <script src="//code.tidio.co/z5kc8dmhzyqbi2jsicorpgjigi0p4kfu.js"></script> -->
