...
-->
    ...
    $('#rangepicker').daterangepicker();
      $(function () { 
        ...
        $('#tabelProfit').DataTable();
        $('#tabelInvestasi').DataTable();
        $('#tabelInvestasi2').DataTable();
        $('#tabelInvestasi3').DataTable();
        $('#tabelInvestasi4').DataTable();
        $('#tabelInvestasi5').DataTable();
        $('#tabelInvestasi6').DataTable();
        
        $('#tabelMember1').DataTable();
        $('#tabelMember2').DataTable();
